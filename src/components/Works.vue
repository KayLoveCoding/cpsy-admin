<template>
  <div class="works-comp">
    <div class="works container">
      <div class="query-box">
        <span class="brand">作品查询</span>
        <div class="flex-s wrap">
          <div class="input-box">
            <p class="title">影赛分类:</p>
