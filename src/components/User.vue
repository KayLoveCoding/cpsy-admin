  ...
  <div class="user-comp">
    <div class="user container">
      ...
      <div class="tool-box">
        ...
        <el-button class="btn" type="warning" @click="authModal" round>审核</el-button>
    ...
    <el-dialog title="添加用户" :visible.sync="showAddModal" width="600px">
      <div class="my-modal-container">
        <div class="query-box">用户属性：团体用户</div>
    ...
    <el-dialog title="平台用户注册信息-待审核" :visible.sync="showAuthModal" width="600px">
      <div class="my-modal-container">
        <div class="table-container">
          <el-table
            ref="authTable"
            ...
            border
            highlight-current-row
            @row-click="toggleAuthSelection"
            @selection-change="getAuthChosen"
            height="300"
          >
            <el-table-column type="selection" width="55"></el-table-column>
      ...
      <span slot="footer" class="dialog-footer text-center flex-c">
        <el-button type="primary" @click="showAuthModal = false">通过</el-button>
        <el-button type="danger" @click="showAuthModal = false">拒绝</el-button>
      </span>
    </el-dialog>
  </div>
</template>
